...
RUN microdnf -y upgrade \
    ...
    && rm -rf /opt/app-root/lib64/python3.12/site-packages/pip /opt/app-root/lib64/python3.12/site-packages/pip-24.2.dist-info \
    && rm -f /opt/app-root/bin/pip /opt/app-root/bin/pip3 /opt/app-root/bin/pip3.12 \
