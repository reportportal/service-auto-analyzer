FROM --platform=${BUILDPLATFORM} bitnami/python:3.11.9 AS test
...
FROM --platform=${BUILDPLATFORM} bitnami/python:3.11.9 AS builder
...
FROM --platform=${BUILDPLATFORM} bitnami/python:3.11.9
WORKDIR /backend/
