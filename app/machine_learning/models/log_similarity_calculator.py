...
# TODO: I cant find any place in the application which uses this model, delete it?
class LogSimilarityCalculator(MlModel):

    def __init__(self, folder, block_to_split=10, min_log_number_in_block=1):
        super().__init__(folder, 'global log similarity model')
