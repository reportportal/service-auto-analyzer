...
class TestService(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.index_logs_rq_different_log_level_merged = "index_logs_rq_different_log_level_merged.json"
        self.index_logs_rq_different_log_level_with_prefix = "index_logs_rq_different_log_level_with_prefix.json"
        ...
        self.search_logs_rq_first_group_2lines_not_for_update = "search_logs_rq_first_group_2lines_not_for_update.json"
        ...
        self.get_suggest_info_by_test_item_ids_query = "get_suggest_info_by_test_item_ids_query.json"
        ...
        self.launch_w_items_clustering_with_different_errors = "launch_w_items_clustering_with_different_errors.json"
        self.cluster_update_all_the_same_es_with_different_errors = (
            "cluster_update_all_the_same_es_with_different_errors.json"
        )
        self.search_logs_rq_first_group_assertion_error = "search_logs_rq_first_group_assertion_error.json"
        self.search_logs_rq_first_group_assertion_error_status_code = (
            "search_logs_rq_first_group_assertion_error_status_code.json"
        )
        self.search_logs_rq_first_group_no_such_element = "search_logs_rq_first_group_no_such_element.json"
        self.search_logs_rq_with_status_codes = "search_logs_rq_with_status_codes.json"
        self.two_hits_search_rs_search_logs_with_status_codes = "two_hits_search_rs_search_logs_with_status_codes.json"
        self.search_not_merged_logs_by_test_item = "search_not_merged_logs_by_test_item.json"
        self.launch_w_items_clustering_with_prefix = "launch_w_items_clustering_with_prefix.json"
        ...
        self.three_hits_search_rs_for_cluster_suggestions = "three_hits_search_rs_for_cluster_suggestions.json"
        ...
        self.index_logs_rq_big_messages_with_clusters = "index_logs_rq_big_messages_with_clusters.json"
