        ...
        tests = [
            {
                ...
                "expected_result": launch_objects.ClusterResult(project=1, launchId=1, clusters=[]),
            },
            {
                "test_calls": [
                    {
            ...
            },
            {
                ...
                "expected_result": launch_objects.ClusterResult(project=2, launchId=1, clusters=[]),
            },
            {
                "test_calls": [
                    {
                    ...
                    },
                    {
                        ...
                        "rq": get_fixture(self.search_logs_rq_first_group_not_for_update),
                    ...
                    },
                    {
                        ...
                        "status": HTTPStatus.OK,
                        "content_type": "application/json",
                        "rq": get_fixture(self.search_logs_rq_second_group_not_for_update),
                        "rs": get_fixture(self.no_hits_search_rs),
                    },
                    {
                ...
                "launch_info": launch_objects.LaunchInfoForClustering(
                    launch=launch_objects.Launch(**(get_fixture(self.launch_w_items_clustering, to_json=True))),
                    project=2,
                    forUpdate=False,
                    numberOfLogLines=-1,
                ),
            ...
            },
            {
                "test_calls": [
                    ...
                    },
                    {
                        ...
                        "status": HTTPStatus.OK,
                        "content_type": "application/json",
                        "rq": get_fixture(self.search_logs_rq_first_group_assertion_error),
                        "rs": get_fixture(self.no_hits_search_rs),
                    },
                    {
                        "method": httpretty.GET,
                ...
                "launch_info": launch_objects.LaunchInfoForClustering(
                    launch=launch_objects.Launch(
                        **(get_fixture(self.launch_w_items_clustering_with_different_errors, to_json=True))
                    ),
                    project=2,
                    forUpdate=False,
                    numberOfLogLines=2,
            ...
            },
            {
                ...
                "launch_info": launch_objects.LaunchInfoForClustering(
                    launch=launch_objects.Launch(
                        **(get_fixture(self.launch_w_small_logs_for_clustering, to_json=True))
                    ),
                    project=2,
                    forUpdate=False,
                    numberOfLogLines=-1,
            ...
            },
            {
                "test_calls": [
                    ...
                    },
                    {
                        ...
                        "status": HTTPStatus.OK,
                        "content_type": "application/json",
                        "rq": get_fixture(self.search_logs_rq_first_group_small_logs_no_numbers),
                        "rs": get_fixture(self.no_hits_search_rs),
                    },
                    {
                        "method": httpretty.GET,
                        ...
                        "status": HTTPStatus.OK,
                        "content_type": "application/json",
                        "rq": get_fixture(self.search_logs_rq_second_group_small_logs_no_numbers),
                        "rs": get_fixture(self.no_hits_search_rs),
                    },
                    {
                        "method": httpretty.GET,
                        ...
                        "status": HTTPStatus.OK,
                        "content_type": "application/json",
                        "rq": get_fixture(self.search_logs_rq_first_group_no_such_element_no_numbers_all_log_lines),
                        "rs": get_fixture(self.no_hits_search_rs),
                    },
                    {
                        "method": httpretty.POST,
                        ...
                        "status": HTTPStatus.OK,
                        "content_type": "application/json",
                        "rq": get_fixture(self.cluster_update_small_logs_no_numbers),
                        "rs": get_fixture(self.index_logs_rs),
                    },
                ],
                "launch_info": launch_objects.LaunchInfoForClustering(
                    launch=launch_objects.Launch(
                        **(get_fixture(self.launch_w_small_logs_for_clustering_numbers, to_json=True))
                    ),
                    project=2,
                    forUpdate=False,
                    numberOfLogLines=-1,
                ...
                "expected_result": launch_objects.ClusterResult(
                    ...
                    clusters=[
                        ...
                        launch_objects.ClusterInfo(
                            clusterId=3268144301345660,
                            clusterMessage="AssertionError [EXCLUDED NUMBER] status code 500 error occurred",
                            logIds=[5],
                            itemIds=[5],
                        ),
                        launch_objects.ClusterInfo(
                            clusterId=86465058569810290,
                            clusterMessage="NoSuchElementException error occurred\nerror found\nassert query",
                            # noqa
                            logIds=[9],
                            itemIds=[6],
