...
class TestRetrainingService(TestService):
    ...
    def test_train_models_triggering(self):
        ...
        tests = [
            {
                "train_info": {"model_type": "defect_type", "project_id": 1, "gathered_metric_total": 5},
                "trigger_info": {},
                "train_result": (0, {}),
            ...
            {
                "train_info": {"model_type": "suggestion", "project_id": 1, "gathered_metric_total": 3},
                "trigger_info": {},
                "train_result": (0, {}),
                "is_model_trained": False
            },
            ...
            {
                "train_info": {"model_type": "suggestion", "project_id": 1, "gathered_metric_total": 5},
            ...
            {
                "train_info": {"model_type": "auto_analysis", "project_id": 1, "gathered_metric_total": 3},
                "trigger_info": {},
                "train_result": (0, {}),
                "is_model_trained": False
            },
            ...
            {
                "train_info": {"model_type": "auto_analysis", "project_id": 1, "gathered_metric_total": 5},
