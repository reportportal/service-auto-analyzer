...
class TestEsQuery(unittest.TestCase):
    ...
    def test_build_analyze_query_two_log_lines(self):
        ...
        log = {
            ...
            "_source": {
                ...
                "only_numbers": "1"}}
        query_from_esclient = es_client.build_analyze_query(launch, "unique", log)
        demo_query = TestEsQuery.build_demo_query_two_log_lines(
            search_cfg, "Launch name",
            "unique", log,
            error_logging_level)
    ...
    @utils.ignore_warnings
    def test_build_analyze_query_small_logs_search(self):
        """Tests building analyze query"""
        search_cfg = {
            "MinShouldMatch": "80%",
            "BoostAA":        10,
        ...
        log = {
            ...
            "_source": {
                ...
                "only_numbers": ""}}
        query_from_esclient = es_client.build_analyze_query(launch, "unique", log)
        demo_query = TestEsQuery.build_demo_query_small_logs_search(
            search_cfg, "Launch name",
            "unique", log,
            error_logging_level)
    ...
    @staticmethod
    @utils.ignore_warnings
    def build_demo_query_small_logs_search(search_cfg, launch_name,
    ...
    @staticmethod
    @utils.ignore_warnings
    def build_demo_query_two_log_lines(search_cfg, launch_name,
                                       unique_id, log, error_logging_level):
        """Build demo analyze query"""
        return {
            "size": 10,
