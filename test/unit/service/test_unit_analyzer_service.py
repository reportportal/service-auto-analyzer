...
DEFAULT_LAUNCH_NAME_SEARCH = {
    "must": [{"term": {"launch_name": DEFAULT_LAUNCH_NAME}}],
    "should": [{"term": {"launch_id": {"value": DEFAULT_LAUNCH_ID, "boost": DEFAULT_BOOST_LAUNCH}}}],
}
