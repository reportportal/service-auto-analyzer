...
def test_calculate_text_similarity_basic_cases(base_text, other_texts, expected_scores):
    ...
    actual_scores, _ = text_processing.calculate_text_similarity(base_text, other_texts)
...
def test_calculate_text_similarity_no_other_texts():
    ...
    result, _ = text_processing.calculate_text_similarity("base text", [])
    assert result == []
...
def test_calculate_text_similarity_appium_exceptions():
    ...
    similarity_scores, _ = text_processing.calculate_text_similarity(ios_exception, [android_exception])
    ...
    first_line_scores, _ = text_processing.calculate_text_similarity(ios_first_line, [android_first_line])
...
def test_calculate_text_similarity_multiple_texts(base_text, other_texts, expected_length):
    ...
    scores, _ = text_processing.calculate_text_similarity(base_text, other_texts)
...
def test_calculate_text_similarity_script_scenarios():
    ...
    for n in range(1, len(HISTORY_TEXTS) + 1):
        result, _ = text_processing.calculate_text_similarity(REQUEST_TEXT, HISTORY_TEXTS[:n])
        assert len(result) == n
...
def test_find_last_unique_texts(test_texts, expected_result):
    logs_left, _ = text_processing.find_last_unique_texts(0.95, test_texts)
